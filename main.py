"""Application entry point for VVVF GTO Simulator MK3."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="VVVF GTO Simulator MK3 — Stage A")
    parser.add_argument(
        "--profile",
        type=Path,
...
def main() -> int:
    ...
    app.setApplicationName("VVVF GTO Simulator MK3")
